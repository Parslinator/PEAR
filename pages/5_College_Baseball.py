...
with st.container(border=True, height=440):
    st.dataframe(modeling_stats_copy[['NET', 'RPI', 'PRR', 'RQI', 'SOS', 'RemSOS', 'Q1', 'Q2', 'Q3', 'Q4', 'Conference']], use_container_width=True)
st.caption("NET - Mimicing the NCAA Evaluation Tool using PRR, RQI, SOS, RPI - PEAR's Attempted RPI, PRR - Power Rating Rank, RQI - Resume Quality Index, SOS - Strength of Schedule, RemSOS - Remaining Strength of Schedule")
