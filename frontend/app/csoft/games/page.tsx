...
export default function CsoftGamesPage() {
  ...
  const fetchGames = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/api/softball/schedule/today`);
  ...
  const getLogoUrl = (teamName: string) => {
    return `${API_URL}/api/softball-logo/${encodeURIComponent(teamName)}`;
  };
