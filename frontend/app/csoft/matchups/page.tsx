...
export default function CsoftMatchupsPage() {
  ...
  const calculateSpread = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/api/softball/calculate-spread`, {
        away_team: awayTeam,
        home_team: homeTeam,
        neutral: neutral
      });
      ...
      // Get matchup image
      const imageResponse = await axios.post(`${API_URL}/api/softball/matchup-image`, {
        away_team: awayTeam,
        home_team: homeTeam,
        neutral: neutral
      }, {
